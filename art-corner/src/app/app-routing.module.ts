...
const routes: Routes = [
  ...
  { path: 'explore/:id', component: EducationalResourcesComponent, data: {page: 'explore', artifacts: initialArtifacts, list: initialArtifacts} },
  { path: 'bookmarks', component: AccessibilityFeaturesComponent, data: {page: 'explore', artifacts: initialArtifacts} },
  { path: 'bookmarks/:id', component: EducationalResourcesComponent, data: {page: 'explore', artifacts: initialArtifacts, list: initialArtifacts} },
